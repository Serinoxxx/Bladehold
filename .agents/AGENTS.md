...
**ALWAYS compile and verify code before handing it back to the user.** Do not act as a blind copy-paster. Use the `compile-check` skill to verify C# code compiles successfully, and check the Unity Editor logs (e.g., via MCP) for runtime errors. Never make the user act as your compiler.
