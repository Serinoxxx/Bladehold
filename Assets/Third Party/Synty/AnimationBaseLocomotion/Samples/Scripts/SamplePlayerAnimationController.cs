...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SamplePlayerAnimationController : MonoBehaviour
    {
        ...
        private readonly int _isHoldingAttackHash = Animator.StringToHash("IsHoldingAttack");

        private readonly int _startAttackHash = Animator.StringToHash("StartAttack");
        ...
        private void Start()
        {
            ...
            _inputReader.onAttackActivated += ActivateAttack;
            _inputReader.onAttackDeactivated += DeactivateAttack;
