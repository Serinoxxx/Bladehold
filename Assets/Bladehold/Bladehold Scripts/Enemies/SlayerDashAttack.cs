...
public class SlayerDashAttack : MonoBehaviour
{
    ...
    [Tooltip("Played at the landing point when the dash lands (ground smash burst, sound, shake).")]
    ...
    private void Start()
    {
        ...
        {
            // Non-fatal: the dash still lands, just without feedback.
            Debug.LogError("[SlayerDashAttack] smashFeedback is not assigned on " + gameObject.name + ".", this);
        }
